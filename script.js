...
// making scores zero by using elements
// starting conditions
/*
...
let currentScore = 0; // to hold the score of the current match
let activePlayer = 0;
const scores = [0, 0];
...
const init = function () {
  scores = [0, 0];
  currentScore = 0; // to hold the score of the current match
  activePlayer = 0;
...
btnHold.addEventListener("click", function () {
  if (playing) {
    // console.log('hold button is pressed');
